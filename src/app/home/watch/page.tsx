...
const Watch = () => {
    ...
    return (
        <div className={`watch_body`}>
            ...
            <div className={`reason grid_box ${currentTheme ? "background_light" : "background_dark"}`}>
                <div className="the_reason center sx12 md6" style={{ backgroundImage: "url('/img/reason1.jpg')" }}>
                    <h3>Quản lý thời gian</h3>
                    <p>
                        Thử tưởng tượng trên tay bạn là một chiếc đồng hồ đẳng cấp!</p><p>
                        Khi bạn đi thi, đi học hay đi làm bạn sẽ không bị muộn giờ.</p><p>
                ...
                <div className="the_reason center sx12 md6" style={{ backgroundImage: "url('/img/reason2.jpg')" }} >
                    ...
                    <p>
                        Thử tưởng tượng trên tay bạn là một chiếc đồng hồ đẳng cấp!</p><p>
                        Khi bạn đi ra đường bạn không thể vớ đại cái quần đùi hay một bộ đồ luộm thuộm và đeo cái đồng hồ đẳng cấp được.</p><p>
                ...
                <div className="the_reason center sx12 md6" style={{ backgroundImage: "url('/img/reason3.jpg')" }} >
                    ...
                    <p>
                        Thử tưởng tượng trên tay bạn là một chiếc đồng hồ đẳng cấp!</p><p>
                        Khi bạn đi ăn đi uống cà phê với bạn bè, bạn không thể ăn tạm mấy món ăn nhanh ăn vặt hay uống một ly trà sửa lề đường được.</p><p>
                        Bạn cũng không thể lui tới những chỗ chỉ ngồi một chỗ và không làm gì được.</p><p>
                ...
                <div className="the_reason center sx12 md6" style={{ backgroundImage: "url('/img/reason4.jpg')" }} >
                    ...
                    <p>
                        Đồng hồ đeo tay cao cấp còn là biểu tượng của đẳng cấp và sự thành công.</p><p>
                        Một chiếc đồng hồ sang trọng có thể giúp bạn khẳng định vị trí và thu hút sự chú ý của người khác.</p><p>
                        Mọi người sẽ nghĩ thế nào về bạn khi bạn đeo một chiếc đồng hồ đẳng cấp,</p><p>
